...
function conky_clock_rings()
    local function setup_rings(cr,pt)
        ...
        elseif pt['name'] == 'weekday' then
            str='${execi 3600 date +%u}'
            str=conky_parse(str)
            value=tonumber(str)
