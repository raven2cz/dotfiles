...
local addIcon = WIDGET_DIR .. '/list-add-symbolic.svg'
if beautiful.scheme_type == "light" then
  addIcon = gcolor.recolor_image(WIDGET_DIR .. '/list-add-symbolic.svg', beautiful.fg_normal)
end
...
local function worker(user_args)
    ...
    if beautiful.scheme_type == "light" then
      icon = gcolor.recolor_image(icon, beautiful.fg_normal)
    end
