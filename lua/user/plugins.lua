...
-- List plugins and commit-ids
function list_plugins()
  for name, plugin in pairs(require('packer').plugins) do
    if plugin['opt'] == false then
      print(name .. ' ' .. plugin['commit'])
    end
  end
end
...
return packer.startup(function(use)
  ...
  -- Treesitter
  use { "nvim-treesitter/nvim-treesitter", commit = "6e8ad92031ff3b07db8980ab4a5491d1c40398ea" }
